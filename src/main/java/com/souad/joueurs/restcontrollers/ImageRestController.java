...
import com.souad.joueurs.service.ImageService;
...
public class ImageRestController {
 ...
 @PostMapping(value = "/uplaodImageJoueur/{idJoueur}" )
 public Image uploadMultiImages(@RequestParam("image")MultipartFile file,
 @PathVariable("idJoueur") Long idJoueur)
throws IOException {
 return imageService.uplaodImageJoueur(file,idJoueur);
 }
@RequestMapping(value = "/getImagesJoueur/{idJoueur}" ,
 ...
 public ResponseEntity<byte[]> getImage(@PathVariable("id") Long id) throws IOException
{
 ...
 public void uploadImageFS(@RequestParam("image") MultipartFile
	 ...
	 Files.write(Paths.get(System.getProperty("user.home")+"/images/"+j.getImagePath())
			 , file.getBytes());
 ...
 Joueur j = joueurService.getJoueur(id);
 return
Files.readAllBytes(Paths.get(System.getProperty("user.home")+"/images/"+j.getImagePath()));
 }
}